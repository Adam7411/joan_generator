function baseswitch(widget_id, url, skin, parameters) {
    ...
    function OnButtonClick(self) {
        // FIX: Use local variable `var args` instead of global `args`
        var args = {};
        if (self.state === self.parameters.state_active) {
            // FIX: Clone the parameters object to avoid mutation
        ...
        // This modification is now safe on the local copy
