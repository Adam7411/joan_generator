...
# Zmieniono VALUE_STYLE, aby obniżyć tekst (padding-top: 15px) dla lepszej czytelności na Joan 6
...
def index():
    ...
    if request.method == 'POST':
        try:
            ...
            # Teraz pobierane z ukrytych pól, które JS aktualizuje (nawet dla Custom Grid)
            ...
            if layout_data_str:
                ...
                for w in processed_widgets:
                    ...
                    # --- 7. INNE (Actionable - Switch, Light, Cover...) ---
                    else:
                        ad_type = w_type
